...
class TestRiskAndRecommendations(unittest.TestCase):
    def setUp(self):
    ...
    def test_risk_scoring_low_risk(self):
        ...
        risk = risk_scoring_service.calculate_multi_factor_risk(self.base_df, budget_limit=10000.0)
        
        self.assertEqual(risk['risk_level'], 'LOW')
        self.assertTrue(risk['risk_score'] <= 30)
        self.assertFalse(risk['is_over_budget'])
    ...
    def test_risk_scoring_high_risk(self):
        ...
        high_spend_df = self.base_df.copy()
        ...
        self.assertTrue(risk['risk_score'] > 70)
        self.assertTrue(risk['is_over_budget'])
    ...
    def test_recommendations_generation(self):
        ...
        recs = recommendation_service.get_recommendations(self.base_df, budget_limit=2000.0)
        ...
        self.assertTrue(food_recs[0]['potential_savings'] > 0)
        self.assertTrue("mess meals" in food_recs[0]['recommendation_text'] or "hostel mess" in food_recs[0]['recommendation_text'])
